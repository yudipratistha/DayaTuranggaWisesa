                    ...
                    <div class="card">
                        ...
                        <ul class="nav nav-tabs profile-tab" role="tablist">
                            <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home"
                                    role="tab"><span class="d-none d-md-block">Company Profile</span><span class="d-block d-md-none"><i class="mdi mdi-bulletin-board"></i></span></a>
                            </li>
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#settings"
                                    role="tab"><span class="d-none d-md-block">Services</span><span class="d-block d-md-none"><i class="mdi mdi-settings"></i></a>
                            </li>
                        </ul>
                        <!-- Tab panes -->
